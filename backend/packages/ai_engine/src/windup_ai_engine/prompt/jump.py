...
- 提示词要写**"只做一次 + 终态保持"**,防 5s 内复读跳第二次(实测坑:不写会连跳)。
...
JUMP_BODY_SIDE = (
    ...
    "off the ground hard and the whole body launches straight upward with the legs tucking "
    "up, the body reaches the top of the jump and hangs there for an instant with {garment} "
